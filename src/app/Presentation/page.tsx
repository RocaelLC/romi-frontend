...
export default function Page() {
    return (
        <main className="max-w-6xl mx-auto px-4 ">
            ...
            <h1 className=" text-center text-3xl font-bold text-[#023E8A] m-12">Nuestro Equipo</h1>
            <p className="text-center text-base text-zinc-600 mt-2">
                Profesionales excepcionales comprometidos con la innovación médica.
            </p>
            <section className="mt-10 grid md:grid-cols-4 gap-6">
                <div className="rounded-2xl border p-6 shadow-inner mt-6 text-center">
                    <User className="mx-auto w-15 h-15 text-blue-600" />
            ...
            <h1 className=" text-center text-3xl font-bold text-[#023E8A] m-12">Nuestra Historia</h1>
            <p className="text-center text-base text-zinc-600 mt-2">
            ...
            <section className="relative mx-auto max-w-6xl py-16">
                ...
                <li className="relative grid grid-cols-1 md:grid-cols-2 items-center">
                    ...
                    <div className="md:pr-12">
                        <div className="rounded-2xl bg-white p-6 shadow-xl ring-1 ring-black/5 md:justify-self-end">
                            <p className="text-indigo-600 font-bold text-lg text-right md:text-left">2020</p>
                ...
                <ol className="space-y-16">
                    ...
                    <li className="relative grid grid-cols-1 md:grid-cols-2 items-center">
                        ...
                        <div className="md:pl-12">
                            <div className="rounded-2xl bg-white p-6 shadow-xl ring-1 ring-black/5">
                                <p className="text-indigo-600 font-bold text-lg">2021</p>
                    ...
                    <li className="relative grid grid-cols-1 md:grid-cols-2 items-center">
                        ...
                        <div className="md:pr-12">
                            <div className="rounded-2xl bg-white p-6 shadow-xl ring-1 ring-black/5 md:justify-self-end">
                                <p className="text-indigo-600 font-bold text-lg text-right md:text-left">2022</p>
                    ...
                    <li className="relative grid grid-cols-1 md:grid-cols-2 items-center">
                        ...
                        <div className="md:pl-12">
                            <div className="rounded-2xl bg-white p-6 shadow-xl ring-1 ring-black/5">
                                <p className="text-indigo-600 font-bold text-lg">2023</p>
                    ...
                    <li className="relative grid grid-cols-1 md:grid-cols-2 items-center">
                        ...
                        <div className="md:pr-12">
                            <div className="rounded-2xl bg-white p-6 shadow-xl ring-1 ring-black/5 md:justify-self-end">
                                <p className="text-indigo-600 font-bold text-lg text-right md:text-left">2024</p>
