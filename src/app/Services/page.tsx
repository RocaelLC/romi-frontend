...
export default function Page() {
  return (
    <main className="max-w-6xl mx-auto px-4">
      <section className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen bg-gradient-to-br from-indigo-700 via-violet-600 to-blue-600">
        <div className="mx-auto max-w-6xl px-4 py-24 text-center text-white">
          <h1 className="text-5xl font-extrabold grid place-items-center">
            Servicios Médicos <span className="text-indigo-200">Integrales</span>
          </h1>
      ...
      <div>
        <h1 className="text-3xl font-bold text-center mt-12 text-indigo-600">Servicios Principales</h1>
      ...
      <section className="mt-10 grid md:grid-cols-2 gap-6">
        <div className="rounded-2xl border p-6">
          ...
          <ul className="mt-4 space-y-2" >
            ...
            <p className="list-disc list-inside"><Check className="h-6 w-6 text-indigo-600 inline-block mr-2" /> Consultas médicas 24/7</p>
            <p className="list-disc list-inside"><Check className="h-6 w-6 text-indigo-600 inline-block mr-2" /> Análisis de síntomas</p>
            <p className="list-disc list-inside"><Check className="h-6 w-6 text-indigo-600 inline-block mr-2" /> Recomendaciones de tratamiento</p>
            <p className="list-disc list-inside"><Check className="h-6 w-6 text-indigo-600 inline-block mr-2" /> Base de datos médica actualizada</p>
            <p className="list-disc list-inside"><Check className="h-6 w-6 text-indigo-600 inline-block mr-2" /> Integración con WhatsApp</p>
          </ul>

          <Link
            href="/chat"
            className="mt-4 inline-flex items-center justify-center
                       rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium
                       text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2
                       focus:ring-indigo-500 focus:ring-offset-2 bg-gradient-to-br from-indigo-700 via-violet-600"
          >
            Explorar Servicio
          </Link>
        </div>
      ...
      <section className="mt-10 grid md:grid-cols-2 gap-6">
        ...
        <div className="rounded-2xl border p-6">
          ...
          <div className="flex items-center">
            ...
            <ImportIcon className="h-10 w-10 text-indigo-600" />
